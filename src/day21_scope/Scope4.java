...
public class Scope4 {
	...
	public static void main(String[] args) {
        ...
        // 2- sayi2++; ==> ilk deger atanmadigi icin artirma yada azaltma da yapamayiz
        // 2- Java deger atamasi olmadan local variable oluturulmasina izin verir, ileride deger atanacak diye bekler
