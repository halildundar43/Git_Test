...
public class Exceptions05 {
	...
	public static void main(String[] args) {
        ...
        // null olarak tanýmlanmýþ bir obje ile uygun olmayan bir iþlem yapmaya calýþtýðýnýzda
        // Java NullPointerException verir
        // Unchecked exception'dir
        
        String str1=" ";
        String str2="";
        String str3=null;   // null bir deger degildir sadece str3'un hiçbirþeye eþit olamdýðýný 
