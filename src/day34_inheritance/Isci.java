...
public class Isci extends Muhasebe {
    ...
    public static void main(String[] args) {
        ...
        // Bu derse kadar hangi class'dan bilgi elde etmek istiyorsak o class'dan obje oluþturduk
        // Inheritance ile bu mecburiyet ortadan kalktý
        // Child class'da oluþturduðum obje ile tüm parent class'larda
       ...
       // System.out.println(id1.id); objenin bilgilerini yazdýrabiliriz
    }
}
