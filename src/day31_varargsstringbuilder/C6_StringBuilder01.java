...
public class C6_StringBuilder01 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("sb1 kapasite " + sb1.capacity()); // 16 bir deger yazmadigimiz icin default cap. 16
        
        System.out.println("sb2 uzunluk " + sb2.length()); // 11 Mehmet Hoca
        System.out.println("sb2 kapasite " + sb2.capacity()); // 22 basta biz 6 olusturduk 16 da önceki default degerden geldi
