...
public class C1_PassByValue01 {
	...
	public static void main(String[] args) {
		...
		Soru : Verilen bir fiyat icin %10 indirim yapan bir method olusturun.
		  ...
		  - Method Call sonrasi original fiyati yazdirin ve method’da yapilan degisikligin  orginal degeri degistirip degistirmedigini kontrol edin.
		*/
		
		double fiyat=100;
		
		indirimUygula(fiyat);
		System.out.println("method call sanrasý fiyat : " + fiyat);
	...
	public static void indirimUygula(double fiyat) {
		...
		System.out.println("method içindeki deðiþiklik " + (fiyat-10)); // 80
	}
